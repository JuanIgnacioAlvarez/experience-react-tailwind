    ...
    <div className="max-w-[14000px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="text-2xl py-6">
          Lorem ipsum dolor sit amet concectetur adipisicing elit. Molestias,
          nam?
        </p>
        <p className="pb-6">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod sequi
          saepe qui blanditiis ea laudantium nostrum culpa alias officiis quia
          dolorum, repellat sunt accusamus at ipsam praesentium nulla quos
          harum.
        </p>
        <div>
